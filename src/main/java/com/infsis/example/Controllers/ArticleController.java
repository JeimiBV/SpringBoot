...
public class ArticleController {
    ...
    public ResponseEntity<ArticleDTO> getArticles(){
        ArticleDTO articleDTO = new ArticleDTO("article", "article reference");
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ArticleDTO> updateUser(@PathVariable Integer id, @RequestBody ArticleDTO articleDTO){
        return ResponseEntity.ok().body(articleDTO);
    }
